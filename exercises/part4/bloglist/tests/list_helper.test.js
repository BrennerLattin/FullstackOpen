...
describe('total likes', () => {
  test('when list is empty, equals zero', () => {
    ...
    const likes = listHelper.totalLikes(emptyBlogs)
  ...
  test('when list has one blog, equals the likes of that blog', () => {
    ...
    const likes = listHelper.totalLikes(singleBlog)
    assert.strictEqual(likes, 7)
  })

  test('when list has multiple blogs, equals sum of likes of blogs', () => {
...
describe('favorite blog', () => {
  test('when list has one blog, equals that one blog', () => {
    ...
    const bestBlog = listHelper.favoriteBlog(singleBlog)
